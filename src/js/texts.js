...
window.cision.websolution.texts["en"].totalReturnDescriptions = function () {
    var intervalKeys = {};
    ...
    var informationParagraphs = [
        ...
        //}, {
            ...
            content: "For information about trade and various instruments, please refer to the Nasdaq OMX Stockholm website.<br/>For information about the SIX Return Index (SIX RX), refer to the SIX Financial Information website."
        }
    ];
...
window.cision.websolution.texts["sv"].totalReturnDescriptions = function () {
    var intervalKeys = {};
    ...
    var informationParagraphs = [
        ...
        //}, {
            ...
            content: "För information om handel och olika instrument hänvisas till Nasdaq OMX Stockholms webbplats.<br/>För information om SIX Return Index (SIX RX) hänvisas till SIX Financial Informations webbplats."
        }
    ];
